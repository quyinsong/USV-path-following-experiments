function  modelplot1( pos, psi,xrange,yrange )
...
%% plot
N=pos(1); E=pos(2);
plot([xn1(2) xn2(2)],[xn1(1) xn2(1)],'b-',[xn2(2) xn3(2)],[xn2(1) xn3(1)],'b-',...
[xn3(2) xn4(2)],[xn3(1) xn4(1)],'b-',[xn4(2) xn5(2)],[xn4(1) xn5(1)],'b-',...
[xn5(2) xn1(2)],[xn5(1) xn1(1)],'b-','linewidth',1.5); % plot ship model
