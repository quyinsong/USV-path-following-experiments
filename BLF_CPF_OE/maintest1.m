...
for k = 1:Ns
    ...
    % 初始化
    if t==0
        x10 = [0.1 0.1 0.1 9 -0.5 0]'; Tc1 = [0 0]';
        x20 = [0.1 0.1 0.1 17.5 -0.5 0]'; Tc2 = [0 0]';
        x30 = [0.1 0.1 0.1 25 -0.3 0]'; Tc3 = [0 0]';
...
%      end
    ...
    [xd1, yd1, alpha_psi1, psip1, kc1, up1, alpha_r1, alpha_u1, xe1, ye1, w(1), a1, b1, psie1, thetahat1] = ...
                              LOSguidance1( pc, 2, eta1, nu1_hat, vs, w(1), ts, t, ew(1) );
    [xd2, yd2, alpha_psi2, psip2, kc2, up2, alpha_r2, alpha_u2, xe2, ye2, w(2), a2, b2, psie2, thetahat2] = ...
                              LOSguidance2( pc, 2, eta2, nu2_hat, vs, w(2), ts, t, ew(2) );
    [xd3, yd3, alpha_psi3, psip3, kc3, up3, alpha_r3, alpha_u3, xe3, ye3, w(3), a3, b3, psie3, thetahat3] = ...
...
%     [xe3_hat, ye3_hat, u3_hat,v3_hat] = LESO3( xe3,ye3,kc3,up3,psi3,psip3,ts );
   ...
   thetaout(k,:)=[thetahat1, thetahat2, thetahat3]';  % 输出自适应参数变化
...
xrange=[-5 10 125]; yrange = [-55 10 55];
for k=1:1000:Ns
...
plot(t,about(:,1),'r--',t,about(:,3),'b--',t,about(:,5),'g--','linewidth',linewid);
plot(t,-about(:,1),'r--',t,-about(:,3),'b--',t,-about(:,5),'g--','linewidth',linewid); hold off
...
plot(t,about(:,2),'r--',t,about(:,4),'b--',t,about(:,6),'g--','linewidth',linewid);
plot(t,-about(:,2),'r--',t,-about(:,4),'b--',t,-about(:,6),'g--','linewidth',linewid); hold off
set(gca,'xTick',tmin:tinterval:tmax);
xlim([tmin tmax]);
xlabel('time (s)');
h1 = ylabel('$$y_{e}\ $$(m)');
...
% 绘制自适应参数变化
figure(12)
plot(t,thetaout(:,1),'r-',t,thetaout(:,2),'b-',t,thetaout(:,3),'g-','linewidth',linewid)
set(gca,'xTick',tmin:tinterval:tmax);
xlim([tmin tmax]);

h1 = legend('$$\hat{\theta}_1$$','$$\hat{\theta}_2$$','$$\hat{\theta}_3$$');
set(h1,'Interpreter','latex'); set(h1,'FontSize',fontsize); set(h1,'FontName',fontname);
set(h1,'FontWeight',fontweight);

h1 = ylabel('$$\hat{\theta}\ $$ (m/s)');
set(h1,'Interpreter','latex'); set(h1,'FontSize',fontsize); set(h1,'FontName',fontname);
set(h1,'FontWeight',fontweight);
h1 = xlabel('time (s)');
set(h1,'Interpreter','latex'); set(h1,'FontSize',fontsize); set(h1,'FontName',fontname);
