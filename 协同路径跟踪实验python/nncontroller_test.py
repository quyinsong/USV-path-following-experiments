# -*- coding: utf-8 -*-
"""
Created on Sun Oct 23 16:54:28 2022
...
for i in range(int(Ns)):
    ...
    usv1 = USV1()
    usv1_nu,usv1_eta,usv1_Tf,usv1_fu,usv1_fr = \
    usv1.state_update(usv1_nu,usv1_eta,usv1_Tf,usv1_Tc,vc,tw,ts)
