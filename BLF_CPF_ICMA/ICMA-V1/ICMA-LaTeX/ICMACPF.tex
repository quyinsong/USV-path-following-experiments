...
%%
\documentclass[conference,letterpaper,10.5pt]{IEEEtran}
...
\begin{document}
% paper title
%\title{\huge Coordinated Path Following for Multiple Underactuated \\Surface Vessels with Error Constraints$^{*}$\footnoterule\thanks{$^{*}$This work is partially
...
\author{\authorblockN{Yuchao Wang, Yinsong Qu, Jiahao Chen, Yabo Wang, Huixuan Fu}
\authorblockA{\textit{College of Intelligent Systems Science and Engineering}\\
\textit{Harbin Engineering University}\\
\textit{Harbin 150001, P.~R.~China}\\
\textit{\{wangyuchao, quyinson, chenjiahao, wangyabo, fuhuixuan\}@heu.edu.cn}
}}%
%\and
%\authorblockN{}
%\authorblockA{\textit{College of Intelligent Systems Science and Engineering}\\
%	\textit{Harbin Engineering University}\\
%	\textit{Harbin 150001, P.~R.~China}\\
%	\textit{\{chenjiahao, wangyabo\}@heu.edu.com}\\}
%}%
...
\begin{thebibliography}{0}
	...
	\bibitem{bib1} Belleter, D. J. W., Pettersen, K. Y., Path following for formations of underactuated marine vessels under influence of constant ocean currents, in \emph{Proceedings of 53rd IEEE Conference on Decision and Control}, pp. 4521--4528, 2014.
	
	\bibitem{bib2} Belleter, D. J. W., Braga, J., Pettersen, K. Y., Experimental Verification of a Coordinated Path-Following Strategy for Underactuated Marine Vehicles, \emph{Frontiers in Robotics and AI}, vol. 6, 2019.
	
	\bibitem{bib3} Gu, N., Wang, D., Peng, Z. and Liu, L., Adaptive bounded neural network control for coordinated path-following of networked underactuated autonomous surface vehicles under time-varying state-dependent cyber-attack, \emph{ISA Transactions}, vol. 104, pp. 212--221, 2020.
	
	\bibitem{bib4} M. Lv, Z. Peng, D. Wang and Q. -L. Han, Event-Triggered Cooperative Path Following of Autonomous Surface Vehicles Over Wireless Network with Experiment Results, \emph{IEEE Trans. on Industrial Electronics}, vol. 69, no. 11, pp. 11479--11489, 2022
	
	\bibitem{bib5} N. Gu, Z. Peng, D. Wang, Y. Shi and T. Wang, Anti disturbance Coordinated Path Following Control of Robotic Autonomous Surface Vehicles: Theory and Experiment, \emph{IEEE/ASME Trans. on Mechatronics}, vol. 24, no. 5, pp. 2386--2396, 2019.
	
	\bibitem{bib6} Mingyu Fu, Lulu Wang, Finite-time coordinated path following control of underactuated surface vehicles based on event-triggered mechanism, \emph{Ocean Engineering}, vol. 246, 2022.
	
	\bibitem{bib7} Peng, Z., Wang, D., Li, T. and Han, M., Output-Feedback Cooperative Formation Maneuvering of Autonomous Surface Vehicles with Connectivity Preservation and Collision Avoidance, \emph{IEEE Trans. on Cybernetics}, vol. 50, no. 6, pp. 2527--2535, 2020.
	
	\bibitem{bib8} Zuo, Z., Song, J., Han and Q.-L., Coordinated Planar Path-Following Control for Multiple Nonholonomic Wheeled Mobile Robots, \emph{IEEE Trans. on Cybernetics}, vol. 52, no. 9, pp. 9404--9413, 2021.
	
	\bibitem{bib9} W. Yao, H. Garcia de Marina, Z. Sun and M. Cao, Distributed coordinated path following using guiding vector fields, in \emph{Proceedings of 2021 IEEE International Conference on Robotics and Automation}, pp. 10030--10037, 2021.
	...
	\bibitem{bib11} Zheng, Z., Sun, L. and Xie, L., Error-Constrained LOS Path Following of a Surface Vessel with Actuator Saturation and Faults, \emph{IEEE Trans. on Systems Man Cybernetics-Systems}, vol. 48, no. 10, pp. 1794--1805, 2018.
	...
	\bibitem{bib13} Li, C., Jiang, J., Duan, F., Liu, W., \emph{et al}., Modeling and Experimental Testing of an Unmanned Surface Vehicle with Rudderless Double Thrusters. \emph{Sensors}, vol. 19, no. 9, 2021.
	
	\bibitem{bib14} Z. Zuo, V. Cichella, M. Xu, and N. Hovakimyan, Three-dimensional coordinated path-following control for second-order multi-agent networks, \emph{J. Franklin Inst.}, pp. 3858--3872, 2015.
	
	\bibitem{bib15} H. Zhang, F. L. Lewis, Adaptive cooperative tracking control of higher-order nonlinear systems with unknown dynamics, \emph{Automatica}, vol. 48, no. 7, pp. 1432--1439, 2012.
