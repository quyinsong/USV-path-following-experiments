...
%% PLOTS
% Initial
fontsize = 11; fontname = 'TimesNewRoman'; linewid = 1;
figure(1);hold on
xrange=[0 5 60]; yrange = [0 5 60];
...
figure(5)
subplot(2,1,1),plot(t,Tc1_FTC(:,1),'r-',t,Tc1_FTC(:,2),'b-',t,Tf_FTC(:,1),'r--',t,Tf_FTC(:,2),'b--','linewid',linewid)
h1=legend('$$T_{c1}-with AFTC$$','$$T_{c2}-with AFTC$$','$$T_{f1}-with AFTC$$','$$T_{f2}-with AFTC$$');
set(h1,'Interpreter','latex'); set(h1,'FontSize',fontsize); set(h1,'FontName',fontname);
ylabel('Thrust (N)','FontSize',fontsize,'FontName',fontname);
xlabel('Time (s)','FontSize',fontsize,'FontName',fontname);
ylim([-60,120]); % ÉèÖÃ×ø±êÖá·¶Î§ 
subplot(2,1,2),plot(t,Tc1(:,1),'r-',t,Tc1(:,2),'b-',t,Tf(:,1),'r--',t,Tf(:,2),'b--','linewid',linewid)
h1=legend('$$T_{c1}-without AFTC$$','$$T_{c2}-without AFTC$$','$$T_{f1}-without AFTC$$','$$T_{f2}-without AFTC$$');
set(h1,'Interpreter','latex'); set(h1,'FontSize',fontsize); set(h1,'FontName',fontname);
ylabel('Thrust (N)','FontSize',fontsize,'FontName',fontname);
xlabel('Time (s)','FontSize',fontsize,'FontName',fontname);
ylim([-60,120]);% ÉèÖÃ×ø±êÖá·¶Î§ 
...
set(h1,'Interpreter','latex');set(h1,'FontSize',fontsize); set(h1,'FontName',fontname);
xlabel('Time (s)','FontSize',fontsize,'FontName',fontname);
ylabel('Faults estimation','FontSize',fontsize,'FontName',fontname);

figure(8)
Threshold = 2*ones(length(t),1);
