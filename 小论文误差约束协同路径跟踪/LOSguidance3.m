function [xd, yd, alpha_psi, psip, kc, up, alpha_r, alpha_u, xe, ye, w, a, b, psie] = LOSguidance3( pc, delta, eta, nu, vs, w, ts, t, ew )
...
alpha_u = 2*u*sin((psi-psip)/2)^2+ud2+v*sin(psi-psip)-kxe0*xe-kxe*a^2*sin(pi*(xe+eps)^2/2/a^2)*cos(pi*xe^2/2/a^2)/pi/(xe+eps);
alpha_psi = psip-betaf-atan2(oe,delta);
