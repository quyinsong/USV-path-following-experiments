function USVplot2( pos, psai)
%USVPLOT2 USVplot2(pos,psai) :plot the geometrical model of ship in real time
%
...
for k=1:1:Ns
    ...
    Rb_n=[cos(psai(k)) -sin(psai(k));
          sin(psai(k)) cos(psai(k))]; 
    ...
    [xn5(2) xn1(2)],[xn5(1) xn1(1)],'k-','linewidth',4);hold on 
    end   

end
 plot(pos(:,2),pos(:,1),'r-','linewidth',1);   % plot the navagation line
