...
for k=1:Ns
   ...
   % Initialize
   if t==0
       psi = 30*pi/180; x = [0 0 0 2 0 psi]'; tau_c = [0 0]';
       Ud = 0.8; dp = 0.26; B = [1 1;dp -dp];
       xT = 0; yT = 0; alphaT = 0*pi/180;
       kr = 0.1; kro = 0.005; vT = 0;
       Vc = [0.2 0.2]'; 
...
%    end
   ...
   H = [2 0; 0 2];
% 
%    phi = yr-30*sin(2*pi*xr/100);
%    n = [ -30*2*pi*cos(2*pi*xr/100)/100 1]'; tau = -[-n(2) n(1)]';
%    H = [30*(2*pi)^2*sin(2*pi*xr/100)/10000 0; 0 0];
